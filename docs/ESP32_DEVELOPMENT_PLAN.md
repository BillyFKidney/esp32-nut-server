...
| `v2.7.7` | `feature/v2.7.7-factory-reset-release` | [Factory reset](ESP32_V2_7_7_FACTORY_RESET_SPEC.md): target-validated release-confirmed reset of all defined user values, including UPS identity/cache state, while preserving firmware and documented recovery boundaries. Clean-image OTA and publication remain. |
