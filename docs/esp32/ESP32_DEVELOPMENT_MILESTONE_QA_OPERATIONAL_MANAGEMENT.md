...
Completed v2.7.0 QA and acceptance records are preserved in
[ESP32_DEVELOPMENT_MILESTONE_QA_OPERATIONAL_MANAGEMENT_QA_RECORDS.md](archive/ESP32_DEVELOPMENT_MILESTONE_QA_OPERATIONAL_MANAGEMENT_QA_RECORDS.md).
The sections below remain the active requirements and recorded decisions.
