...
| Field | Current fact |
| --- | --- |
| Active branch | `release/v2.8.16-nut-diagnostics-time` is based on published v2.8.15 main. It owns the reviewed v2.8.16 diagnostic-time maintenance candidate; exact-tag build and normal-station acceptance remain pending. |
