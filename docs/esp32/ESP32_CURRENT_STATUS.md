...
| Field | Current fact |
| --- | --- |
| Active branch | `main` contains the released v2.8.5 Wi-Fi scan review slice. The exact tested release source is annotated `v2.8.5` at `9a4f86217`; remote divergence is refreshed at release closeout. |
...
action is to select and contract the next dedicated `v2.8.Z` review from the
explicit v2.8.2 `SKIP` debt.
