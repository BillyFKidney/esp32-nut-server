...
| Field | Current fact |
| --- | --- |
| Active branch | `review/device-route-json-escaping` is based on `main` at `27b2dd0a1`; it owns one standing-approved v2.8.Z device-response JSON-escaping review item. |
