...
| Field | Current fact |
| --- | --- |
| Active branch | `release/v2.8.15-wifi-credentials-storage` contains the published v2.8.15 Wi-Fi credential-storage maintenance release. The next isolated candidate is v2.8.16 diagnostic-time constant maintenance. |
