...
| Field | Current fact |
| --- | --- |
| Active branch | `release/v2.8.17-time-storage-import-order` contains published v2.8.17. Fresh review of inherited-compatibility debt is the next unversioned scope. |
