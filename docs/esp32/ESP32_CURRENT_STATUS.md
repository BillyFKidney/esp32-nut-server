...
| Field | Current fact |
| --- | --- |
| Active branch | `release/v2.8.15-wifi-credentials-storage` is based on published v2.8.14 main. It owns the reviewed v2.8.15 Wi-Fi credential-storage maintenance candidate; exact-tag build and normal-station acceptance remain pending. |
