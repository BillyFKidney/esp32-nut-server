...
| Release preflight | All five v2.8.13–v2.8.17 candidate heads passed a fresh ESP-IDF v6.0.2 reconfigure/build/size check with 59% app-partition headroom. 1Password desktop integration must be restored before redacted certificate-pin/token validation and OTA acceptance; v2.8.13 also needs a credential-safe captive-portal runtime exercise. |
