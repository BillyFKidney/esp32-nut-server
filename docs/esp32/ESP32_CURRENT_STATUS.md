...
| Field | Current fact |
| --- | --- |
| Active branch | `main` contains the released v2.8.1 maintenance slice, including the documentation reorganization. The exact tested release source is annotated `v2.8.1` at `4406e0f60`; remote divergence is refreshed at release closeout. |
