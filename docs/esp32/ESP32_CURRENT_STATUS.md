...
| Field | Current fact |
| --- | --- |
| Active branch | `release/v2.8.14-dns-server-lifecycle` contains the published v2.8.14 DNS worker-lifetime maintenance release. The next isolated candidate is v2.8.15 credential-storage maintenance. |
