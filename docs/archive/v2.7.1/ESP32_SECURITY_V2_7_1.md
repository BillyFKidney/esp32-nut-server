# Historical v2.7.1 security guidance snapshot

This frozen snapshot preserves the detailed security guidance in force through
v2.7.1, including generic and superseded material. It is not the current
security contract; use [ESP32_SECURITY.md](../ESP32_SECURITY.md) for active
requirements and [ESP32_DEVELOPMENT_MILESTONE_QA_OPERATIONAL_MANAGEMENT.md](../ESP32_DEVELOPMENT_MILESTONE_QA_OPERATIONAL_MANAGEMENT.md)
for locked product decisions.
