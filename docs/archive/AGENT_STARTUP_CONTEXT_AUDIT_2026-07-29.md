...
| File | Lines | Bytes | Estimated tokens |
| --- | ---: | ---: | ---: |
| `AGENTS.md` | 91 | 5,398 | 1,350 |
| `docs/ESP32_CURRENT_STATUS.md` | 106 | 5,764 | 1,441 |
| **Total** | **197** | **11,162** | **2,791** |

Compared with the former six-file startup prompt, the default context is
**163,398 bytes smaller (93.6%)** and saves approximately **40,849 tokens**.

The status file itself fell from **101,910 bytes to 5,764 bytes**, a reduction
of **96,146 bytes (94.3%)**. Its line count fell from **1,595 to 106**.
...
| --- | ---: | ---: | ---: |
| `AGENTS.md` | 5,585 | 5,398 | 187 (3.3%) |
| `docs/ESP32_CURRENT_STATUS.md` | 101,910 | 5,764 | 96,146 (94.3%) |
...
| **Total** | **174,560** | **64,638** | **109,922 (63.0%)** |

The same-six-file token estimate falls from approximately **43,640 to 16,161**.
