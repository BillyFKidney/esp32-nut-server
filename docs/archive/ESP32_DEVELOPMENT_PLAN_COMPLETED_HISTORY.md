...
## v2.7.1 repair, publication, and validation history

The following completed records were consolidated here on 2026-08-16 from the
former standalone v2.7.1 header-limit repair and release-validation files.
